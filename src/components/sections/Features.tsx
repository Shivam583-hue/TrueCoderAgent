...
const CATEGORIES = [
  {
    ...
    items: [
      ...
      { rest: "Turn-based history — an incomplete turn never enters the record" },
  ...
  },
  {
    path: "~/tools",
    items: [
      { b: "15 approval-gated tools", rest: " — read, write, edit, grep, glob, shell, delegate…" },
      { b: "edit_file", rest: " applies multi-site edits atomically, one approval" },
      { rest: "Durable memory — " },
      { b: "remember / forget", rest: ", corrected with replaces" },
  ...
  },
  {
    ...
    items: [
      ...
      { rest: "Context budget enforced — oversized results are shortened, never silent" },
    ],
  },
  {
    path: "~/audit",
    items: [
      ...
      { rest: "Crash recovery leases nonterminal runs — never trusts a bare PID" },
  ...
  },
  {
    ...
    items: [
      ...
      { b: "/models", rest: " hot-swaps the active model — no restart required" },
      { b: "web_fetch", rest: " is SSRF-resistant — public addresses only" },
